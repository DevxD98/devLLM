...
DevLLM is a research platform as well as an educational codebase. Reading primary literature is essential for understanding *why* transformer components were designed the way they are. 

This document serves as the curated reading list of foundational papers that inspired DevLLM. Each paper entry outlines **what it introduced**, **why it matters**, and links to deep-dive notes in [`research/paper_notes/`](../research/paper_notes/).
...
- **Why it matters:** Formed the structural foundation for DevLLM's pre-norm architecture ([`ADR-0002`](../research/design_decisions/ADR-0002-pre-norm.md)) and weight-tying default ([`ADR-0003`](../research/design_decisions/ADR-0003-weight-tying-default.md)).
...
- **Why it matters:** Directly incorporated as DevLLM's v0.1 baseline default ([`ADR-0003`](../research/design_decisions/ADR-0003-weight-tying-default.md)), saving $V \cdot C$ parameters and memory.
...
- **Why it matters:** DevLLM's standard optimizer ([`11_TRAINING_PIPELINE.md`](11_TRAINING_PIPELINE.md)).
...
- **Why it matters:** Modern activation choice in DevLLM FFN sublayers ([`09_TRANSFORMER.md`](09_TRANSFORMER.md)).
